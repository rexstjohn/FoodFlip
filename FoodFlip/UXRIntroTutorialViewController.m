...
@interface UXRIntroTutorialViewController ()
...
@implementation UXRIntroTutorialViewController
{
...
- (void)placeViews
{
    ...
    self.unicorn = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"image_3"]];
    ...
    self.wordmark = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"image_2"]];
    ...
    firstPageText.text = @"Introducing Food Flip";
    ...
    secondPageText.text = @"The visual way to explore nearby restaurants";
    ...
    thirdPageText.text = @"Swipe right to left to see nearby restaurants";
    ...
    fourthPageText.text = @"Pull down to enter a restaurant search query";
